      ...
      <CardFooter className="flex justify-end space-x-2 pt-2 pb-3 px-4 border-t mt-auto">
          ...
          <TooltipProvider>
            <Tooltip>
              <TooltipTrigger asChild>
                <Button variant="ghost" size="icon" onClick={() => onAccept(id)} aria-label="Accept suggestion">
        ...
        {validation_status !== "rejected" && (
          <TooltipProvider>
            <Tooltip>
              <TooltipTrigger asChild>
                <Button variant="ghost" size="icon" onClick={() => onEdit(id)} aria-label="Edit suggestion">
        ...
        {isAccepted && (
          <TooltipProvider>
            <Tooltip>
              <TooltipTrigger asChild>
                <Button variant="ghost" size="icon" onClick={() => onUnaccept(id)} aria-label="Unaccept suggestion">
        ...
        {!isAccepted && validation_status !== "rejected" && (
          <TooltipProvider>
            <Tooltip>
              <TooltipTrigger asChild>
                <Button variant="ghost" size="icon" onClick={() => onReject(id)} aria-label="Reject suggestion">
    ...
    return (
      <TooltipProvider>
        <Tooltip delayDuration={300}>
          ...
          >
            <p className="text-sm font-semibold mb-1">Validation Issue:</p>
